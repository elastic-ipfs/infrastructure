...
bitswap_peer_record_name = <%= output('dns-certificate.bitswap_peer_record_name', mock: {}) %>
...
### TODO: Create these variables. Isolate peer_id per env
port   = 443
peer_id = bafzbeibhqavlasjc7dvbiopygwncnrtvjd2xmryk5laib7zyjor6kf3avm
application_layer_protocol = wss
